...
struct ProfileMenuCell: Identifiable {
    ...
    static let profileMenuCells = [
        ProfileMenuCell(
            id: 1,
            icon: Image(R.image.personFill),
            title: R.string.localizable.personData(),
            cellType: .personalData
        ),
        ProfileMenuCell(
            id: 2,
            icon: Image(R.image.newspaper),
            title: R.string.localizable.rulesText(),
            cellType: .conditions
        ),
        ProfileMenuCell(
            id: 3,
            icon: Image(R.image.questionFill),
            title: R.string.localizable.faQ(),
            cellType: .faq
        ),
        ProfileMenuCell(
            id: 4,
            icon: Image(R.image.chatBubbles),
